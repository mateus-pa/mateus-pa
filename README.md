# 👋 Olá, mundo! 👋
Meu nome é Mateus Pinheiro, sou **Back-end Developer**, e estou em transição de carreira para me tornar um programador. A minha árdua jornada de estudos sobre programação começou durante o ano de 2022. Fui aluno bolsista em 2023 do programa do [@PotênciaTech](https://potenciatech.com.br/), em parceria com a [@CubosAcademy](https://aulas.cubos.academy/), do curso de desenvolvimento de software com foco em Back-end. Em 2025 fui aluno bolsista do programa Ford Enter. Parceria entre Ford, SENAI Cimatec e Rede Cidadã para formar programadores Front-end utilizando Angular.
